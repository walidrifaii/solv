...
const headingClass =
  "mb-4 text-xs font-semibold tracking-[0.18em] text-black uppercase";
...
export function Footer() {
  ...
  return (
    <footer
      className="relative mt-auto overflow-hidden bg-[#a5a196] text-black"
      style={{
        backgroundImage:
    ...
    >
      <div className="mx-auto grid w-full max-w-[1400px] grid-cols-2 gap-x-4 gap-y-8 px-4 py-12 sm:gap-x-6 sm:gap-y-10 sm:px-6 sm:py-14 md:gap-x-8 md:gap-y-12 md:px-8 lg:grid-cols-5 lg:gap-x-8 lg:px-10 lg:py-16">
        <div className="col-span-2 lg:col-span-1">
          ...
          <p className="mt-3 max-w-[18rem] text-sm leading-relaxed text-black/65">
            {t("brandDescription")}
          </p>
          ...
          <ul className="space-y-3 text-sm text-black/70">
            <li>
              <a
                ...
                className="inline-flex items-center gap-2.5 transition-colors hover:text-black"
              >
            ...
            <li className="inline-flex items-start gap-2.5">
              <ClockIcon className="mt-0.5 size-4 shrink-0 text-black" />
              <span>{t("hours")}</span>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-black/10">
        <div className="mx-auto flex w-full max-w-[1400px] flex-col items-center justify-between gap-2 px-4 py-4 text-center text-xs text-black/45 sm:flex-row sm:px-6 sm:text-start md:px-8 lg:px-10 sm:text-sm">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-black/75 underline-offset-2 transition-colors hover:text-black hover:underline"
            >
              amctag
            </a>
          </p>
