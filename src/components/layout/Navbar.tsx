...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/10 bg-[#a5a196]/90 text-black backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between gap-3 px-4 sm:h-[4.5rem] sm:px-6 md:h-20 md:px-8 lg:grid lg:h-24 lg:grid-cols-[auto_1fr_auto] lg:items-center lg:gap-6 lg:px-10 xl:gap-8">
              ...
              >
                ...
                {shopOpen ? (
                  <div className="absolute top-full left-1/2 z-20 min-w-48 -translate-x-1/2 pt-3">
                    <div className="rounded-md border border-black/10 bg-[#a5a196]/95 py-2 shadow-xl backdrop-blur-md">
        ...
        <div className="relative z-10 flex shrink-0 items-center justify-end gap-1 sm:gap-2 md:gap-3 lg:justify-self-end">
          ...
          <button
            type="button"
            onClick={openSearch}
            className="inline-flex shrink-0 p-1.5 text-black transition-colors hover:text-black/70"
            aria-label={t("search")}
          >
          ...
          <Link
            href={accountHref}
            className="hidden shrink-0 p-1.5 text-black transition-colors hover:text-black/70 md:inline-flex"
          ...
          <button
            type="button"
            onClick={openCart}
            className="relative hidden shrink-0 cursor-pointer p-1.5 text-black transition-colors hover:text-black/70 sm:inline-flex"
          ...
          <button
            type="button"
            className="inline-flex shrink-0 p-1.5 text-black transition-colors hover:text-black/70 lg:hidden"
      ...
      {mobileOpen ? (
        <div className="max-h-[calc(100svh-4rem)] overflow-y-auto border-t border-black/10 bg-[#a5a196]/98 px-4 py-5 text-black backdrop-blur-md sm:px-6 lg:hidden">
