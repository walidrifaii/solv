...
export async function ContactHero() {
  ...
  return (
    <section className="relative isolate min-h-[42svh] w-full overflow-hidden bg-[#a5a196] text-white sm:min-h-[48svh] md:min-h-[52svh]">
      <Image
        src={heroImage}
        alt=""
        fill
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t from-[#a5a196] via-[#a5a196]/60 to-[#a5a196]/30" />
