    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 flex items-end justify-between gap-2 p-2.5 sm:gap-3 sm:p-4">
        ...
        <button
          type="button"
          onClick={handleAdd}
          className="relative z-20 inline-flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-md bg-[#C9A962] text-white transition-colors hover:bg-[#D9BC82] sm:size-10"
