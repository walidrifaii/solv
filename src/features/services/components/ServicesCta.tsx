...
export async function ServicesCta() {
  ...
  return (
    <section className="relative isolate min-h-[18rem] overflow-hidden bg-[#a5a196] text-white sm:min-h-[20rem] md:min-h-[22rem] lg:min-h-[24rem]">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#a5a196]/95 via-[#a5a196]/70 to-[#a5a196]/45" />
      ...
      <div className="relative z-10 mx-auto flex min-h-[18rem] w-full max-w-[1400px] items-center px-4 py-10 sm:min-h-[20rem] sm:px-6 sm:py-12 md:min-h-[22rem] md:px-8 md:py-14 lg:min-h-[24rem] lg:px-10">
        <div className="max-w-xl md:max-w-2xl">
          ...
          <Link
            ...
            className="mt-6 inline-flex w-fit items-center gap-2 rounded-md bg-[#C9A962] px-5 py-2.5 text-sm font-medium text-[#a5a196] transition-colors hover:bg-[#D9BC82] sm:mt-8 sm:px-6 sm:py-3 sm:text-base"
          >
            {t("label")}
