        ...
        <div className="grid grid-cols-1 gap-px overflow-hidden border border-[#e8ddd2] bg-[#e8ddd2] sm:grid-cols-2 lg:grid-cols-3">
          {serviceItems.map((service) => {
            ...
            return (
              ...
              >
                <Icon className="mb-4 size-11 text-[#C9A962] sm:size-12" />
                <h3 className="font-serif text-xl font-semibold text-[#a5a196] sm:text-[1.35rem]">
                ...
                <ul className="mt-5 space-y-2 border-t border-[#e8ddd2] pt-5">
                  {points.map((n) => (
                    ...
                    >
                      <span
                        className="mt-2 size-1 shrink-0 rounded-full bg-[#C9A962]"
                        aria-hidden
                      />
                      {t(`items.${service.id}.p${n}`)}
                    </li>
                  ))}
                </ul>
              </article>
