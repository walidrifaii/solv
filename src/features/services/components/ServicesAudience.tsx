        ...
        <div>
          ...
          <ul className="mt-8 space-y-6 sm:mt-10">
            {servicesAudience.groupIds.map((groupId, index) => (
              ...
              >
                <span className="font-serif text-2xl leading-none font-medium text-[#C9A962] sm:text-3xl">
                  {String(index + 1).padStart(2, "0")}
                </span>
                <div>
                  <h3 className="font-serif text-lg font-semibold text-[#a5a196] sm:text-xl">
                    {t(`${groupId}.title`)}
                  </h3>
