          ...
          <section className="rounded-xl border border-[#e8ddd2] bg-white px-4 py-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <button
                ...
                className="rounded-xl bg-[#C9A962] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#D9BC82] disabled:cursor-not-allowed disabled:opacity-60"
              >
